 ...
 * Variable to rename <%v_ab_cde_fgh_1_school%>, <%v_ab_cde_fgh_3_kk%>, <%v_ab_cde_fgh_4_urine%>
 */
...
FROM <%v_ab_cde_fgh_1_school%> w
LEFT JOIN <%v_ab_cde_fgh_3_kk%> k ON k.k_school_id = w.w_school_id
LEFT JOIN <%v_ab_cde_fgh_4_urine%> u ON u.u_school_id = w.w_school_id
