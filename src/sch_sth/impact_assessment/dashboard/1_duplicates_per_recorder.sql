 ...
 * Author: Dyesse YUMBA
 * Last Modified: Monday, 11th May 2020 8:18:01 pm
 ...
 * Variable to rename <%metabase_sch_sth_tas_duplicates_202005%>, <%ab_cde_fgh_3_kk%>, <%v_ab_cde_fgh_4_urine%>
 */
 SELECT
...
FROM (
  SELECT
    ...
    FROM public.<%metabase_sch_sth_tas_duplicates_202005%> m
